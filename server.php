...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM userprofile WHERE username='$username' OR contactno='$contactno' OR email='$email' LIMIT 1";
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO userprofile ( username, email, contactno, password) 
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "SELECT * FROM userprofile WHERE username='$username' AND password='$password'";
